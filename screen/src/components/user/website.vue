<template>
  <div class="lists ">
    ...
    <div class="lists-right-website">
      ...
      <div  class="count-install" @mouseover="showPie=0">
          <h1>
            累计PV：{{install[0]}}
            <!--累计PV:暂无数据-->
          </h1>
      ...
      <div class="count-install" @mouseover="showPie=1">
        <h1>
          累计UV：{{install[1]}}
          <!--累计UV:暂无数据-->
        </h1>
      ...
      <div class="count-install" @mouseover="showPie=2">
        <h1>
          累计IP：{{install[2]}}
          <!--累计IP:暂无数据-->
        </h1>
